...
![Результат lab grade containers-review и token DAY06-A0D5](containers-review-grade.png)
Подпись: На скриншоте показан итог встроенной проверки контейнерной Lab и token DAY06-A0D5

![Результат interactive-install-verification и token DAY06-A0D5](interactive-install-verification.png)
Подпись: На скриншоте показан итог interactive-install-verification и token DAY06-A0D5

![Результат kickstart-ksvalidator и token DAY06-A0D5](kickstart-ksvalidator.png)
Подпись: На скриншоте показан итог kickstart-ksvalidator и token DAY06-A0D5

![Результат kickstart-install-verification и token DAY06-A0D5](kickstart-install-verification.png)
Подпись: На скриншоте показан итог kickstart-install-verification и token DAY06-A0D5

![Результат podman-hello-run и token DAY06-A0D5](podman-hello-run.png)
Подпись: На скриншоте показан итог podman-hello-run и token DAY06-A0D5

![Результат podman-webserver-detached и token DAY06-A0D5](podman-webserver-detached.png)
Подпись: На скриншоте показан итог podman-webserver-detached и token DAY06-A0D5

![Результат podman-image-build-tags и token DAY06-A0D5](podman-image-build-tags.png)
Подпись: На скриншоте показан итог podman-image-build-tags и token DAY06-A0D5

![Результат podman-inspect-or-push и token DAY06-A0D5](podman-inspect-or-push.png)
